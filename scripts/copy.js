function changeHeaderBlocks(){
    ...
    if (window.matchMedia("(orientation: portrait) or ((orientation: landscape) and (max-width: 800px))").matches){
        ...
        /*let max = header_container_text.length * 92;
        let startX = 0;
        let scrollLeft = 0;
        slider_certs[0].addEventListener('touchstart', function(e){
        startX = e.touches[0].clientX;
        scrollLeft = this.scrollLeft;
    });

    slider_certs[0].addEventListener('touchmove', function(e){      
        let moveX = e.touches[0].clientX - startX;
        targetScrollLeft = scrollLeft - moveX;
    });
    slider_certs[0].addEventListener('touchend', function(e){
    ...
    /*function sliderCurrentPosition(target){
...
if (window.matchMedia("(orientation: portrait) or ((orientation: landscape) and (max-width: 800px))").matches){
    ...
    /*let startX = 0;
    let scrollLeft = 0;
    block_3_slider[0].addEventListener('touchstart', function(e){
    startX = e.touches[0].clientX;
    scrollLeft = this.scrollLeft;
});

block_3_slider[0].addEventListener('touchmove', function(e){      
    let moveX = e.touches[0].clientX - startX;
    targetScrollLeft = scrollLeft - moveX;
});
block_3_slider[0].addEventListener('touchend', function(e){
    if (targetScrollLeft > 10){
        offset += 100;
        if (offset >= max){
            offset = 0;
        ...
        sliderCurrentPos(target)
    }else if (targetScrollLeft < -10){
        offset -= 100;

        if (offset < 0){
            offset = max - 100;
            target = block_3_slider_item.length - 1; 
        }else{
            target--;
        }
        block_3_slider[0].style.left = -offset + "vw";
...
/*function sliderCurrentPos(target){
...
if (window.matchMedia("(orientation: portrait) or ((orientation: landscape) and (max-width: 800px))").matches){
    ...
    /*let startX = 0;
    let scrollLeft = 0;
    block_4_slider[0].addEventListener('touchstart', function(e){
    startX = e.touches[0].clientX;
    scrollLeft = this.scrollLeft;
});

block_4_slider[0].addEventListener('touchmove', function(e){      
    let moveX = e.touches[0].clientX - startX;
    targetScrollLeft = scrollLeft - moveX;
});
block_4_slider[0].addEventListener('touchend', function(e){
    if (targetScrollLeft > 10){
        offset += 100;
        if (offset >= max){
            offset = 0;
        ...
        block_4_slider[0].style.left = -offset + "vw";

        sliderCurrentP(target);
    }else if (targetScrollLeft < -10){
        offset -= 100;

        if (offset < 0){
            offset = max - 100;
            target = block_4_item.length - 1; 
        }else{
            target--;
        }
        block_4_slider[0].style.left = -offset + "vw";
...
/*function sliderCurrentP(target){
...
if (window.matchMedia("(orientation: portrait) or ((orientation: landscape) and (max-width: 800px))").matches){
    ...
    /*let startX = 0;
    let scrollLeft = 0;
    block_5_slider[0].addEventListener('touchstart', function(e){
    startX = e.touches[0].clientX;
    scrollLeft = this.scrollLeft;
});

block_5_slider[0].addEventListener('touchmove', function(e){      
    let moveX = e.touches[0].clientX - startX;
    targetScrollLeft = scrollLeft - moveX;
});
block_5_slider[0].addEventListener('touchend', function(e){
    if (targetScrollLeft > 10){
        offset += 100;
        if (offset >= max){
            offset = 0;
        ...
        block_5_slider[0].style.left = -offset + "vw";
...
let targetScrollLeft = 0;
    ...
    slider[0].addEventListener('touchend', function(e){
        if (targetScrollLeft > 10){
            ...
            slider[0].style.left = -offset + "vw";
            func === 1 ? sliderCurrentPositionHeader(target) : sliderCurrentPositionBlock_3(target);
        }
